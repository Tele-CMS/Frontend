...
export class SoapComponent implements OnInit {
  ...
  constructor(
    ...
    this.activatedRoute.queryParams.subscribe(params => {
      this.appointmentId = params.apptId == undefined ? 0 : parseInt(this.commonService.encryptValue(params.apptId, false));
      this.encounterId = params.encId == undefined ? 0 : parseInt(this.commonService.encryptValue(params.encId, false));
        ...
        response => {
          ...
          if (response.statusCode == 200) {
            ...
            if (!this.encounterId) {
              ...
              this.router.navigate(["/web/client/encounter/soap"], {
                queryParams: {
                  id: patientId,
