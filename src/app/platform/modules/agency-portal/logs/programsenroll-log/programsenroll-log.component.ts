...
@Component({
  selector: 'app-programsenroll-log',
  templateUrl: './programsenroll-log.component.html',
  styleUrls: ['./programsenroll-log.component.css']
})
export class MemberProgramsEnrollComponent implements OnInit {
  metaData: any;
  searchText: string = '';
  ...
  getHRAEmailAndMessageReportLog(filterModel: any) {
    filterModel.moduleKey = 'MemberProgramsEnroll'
    this.metaData = [];
    this.metaData.pageSizeOptions = [5,10,25,50,100];
    this.auditLogService.getHRAEmailAndMessageReportLog(filterModel,2,this.userId).subscribe((response: ResponseModel) => {
