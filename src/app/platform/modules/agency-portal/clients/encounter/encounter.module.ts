...
@NgModule({
  ...
  declarations: [SoapComponent, SignDialogComponent, EncounterComponent,EncounterPrintPDFModalComponent, EncounterNotesModelComponent],
  ...
  entryComponents: [SignDialogComponent, EncounterPrintPDFModalComponent, EncounterNotesModelComponent],
