...
export class EncounterComponent implements OnInit, OnDestroy {
  ...
  displayedColumns: Array<any> = [
    { displayName: 'Date Of Service', key: 'dateOfService', isSort: true, class: '', width: '100px' },
    ...
    { displayName: 'Chief Complaint', key: 'manualChiefComplaint', class: '', width: '150px', type: "25", isInfo: true },
  ...
  createModal() {
    ...
    this.ReviewOfSyatemsDialogModal.open(ReviewOfSystemsModelComponent, { data: {id:2} })
  }
}
