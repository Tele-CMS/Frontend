...
export class MessageModalComponent implements OnInit {
  ...
  clientBulkMessage: ClientEncounterFilterModel
  filterParams: any;
  submitted: boolean = false;
  constructor(private formBuilder: FormBuilder,
    private clientEncService: ClientEncounterService,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private notifier: NotifierService,
    private dialogModalRef: MatDialogRef<MessageModalComponent>,) {
    
    this.clientBulkMessage = new ClientEncounterFilterModel();
  ...
  onSubmit() {
    ...
    // this.clientEncService.sendBulkMessage(filters).subscribe((response: any) => {
