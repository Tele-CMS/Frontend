...
export class EmailModalComponent implements OnInit {
  ...
  clientBulkEmail: ClientEncounterFilterModel;
  filterParams: any;
  submitted: boolean = false;
  emailObj: ClientEncounterFilterModel;
  constructor(   private clientEncService: ClientEncounterService,
    private dialogModalRef: MatDialogRef<EmailModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private notifier: NotifierService,
    private formBuilder: FormBuilder) {
    this.clientBulkEmail = new ClientEncounterFilterModel();
...
onSubmit() {
  ...
  // this.clientEncService.sendBulkEmail(filters).subscribe((response: any) => {
